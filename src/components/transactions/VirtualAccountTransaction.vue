  ...
  <div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-subheader">
      <div class="d-flex align-items-center">
        <div class="mr-auto">
          <h3 class="m-subheader__title m-subheader__title--separator">Virtual Account Transactions</h3>
      ...
      const options = {
        ...
        columns: [{
            ...
            template: function(row){
              return `<a href="#/transactions/virtualAccountTransaction/123456789">${row.vaNumber}</a>`;
            }
        }, {
            field: "name",
            title: "Name",
