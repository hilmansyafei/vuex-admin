  ...
  <div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-subheader">
      <div class="d-flex align-items-center">
        <div class="mr-auto">
          <h3 class="m-subheader__title m-subheader__title--separator">Merchant Management</h3>
              ...
              <!--begin: Form Body -->
                ...
                <div class="m-wizard__form-step m-wizard__form-step--current" id="m_wizard_form_step_1">
                        ...
                        <div class="form-group m-form__group row">
													...
													<div class="col-xl-9 col-lg-9">
														<input type="text" name="name" class="form-control m-input" placeholder="" value="Canopus Merchant M-0001">
														<span class="m-form__help">
                        ...
                        <div class="form-group m-form__group row">
													...
													<div class="col-xl-9 col-lg-9">
														<input type="text" name="name" class="form-control m-input" placeholder="" value="M-0001">
														<span class="m-form__help">
                        ...
                        <div class="form-group m-form__group row">
													...
													<div class="col-xl-9 col-lg-9">
														<input type="text" name="name" class="form-control m-input" placeholder="" value="1234567890">
														<span class="m-form__help">
															Please enter npwp ID
														</span>
													</div>
												</div>
                        <div class="form-group m-form__group row">
