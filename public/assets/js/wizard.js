  ...
  $.fn.mWizard = function(options) {
    ...
    var Plugin = {
      ...
      build: function() {
        ...
        wizard
          .find(".m-wizard__step a.m-wizard__step-number")
          .on("click", function() {
            var step = $(this).parents(".m-wizard__step");
            var num;
            $(this)
              .parents(".m-wizard__steps")
              .find(".m-wizard__step")
              .each(function(index) {
                if (step.is($(this))) {
                  num = index + 1;
      ...
      updateUI: function(argument) {
        ...
        wizard
          .find(".m-wizard__step")
          .removeClass("m-wizard__step--current")
          .removeClass("m-wizard__step--done");
        for (var i = 1; i < wizard.currentStep; i++) {
          wizard
            .find(".m-wizard__step")
            .eq(i - 1)
            .addClass("m-wizard__step--done");
        }
        wizard
          .find(".m-wizard__step")
          .eq(wizard.currentStep - 1)
          .addClass("m-wizard__step--current");
      },
      ...
      updateProgress: function() {
        ...
        if (element.hasClass("m-wizard--1")) {
          ...
          var progress =
            (wizard.currentStep - 1) * (100 * (1 / (wizard.totalSteps - 1)));
      ...
      handleTarget: function() {
        ...
        element
          .find(".m-wizard__form-step--current")
          .removeClass("m-wizard__form-step--current");
